...
#
# Created: Wed Jan 26 19:04:43 2011
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout.addWidget(self.TimesFilterLineEdit, 1, 5, 1, 1)
        ...
        self.gridLayout.addWidget(self.TimesFilterClear, 1, 6, 1, 1)
        ...
        self.gridLayout.addWidget(self.RunsProxyView, 3, 0, 1, 4)
        ...
        self.gridLayout.addWidget(self.TimesProxyView, 3, 5, 1, 6)
        spacerItem = QtGui.QSpacerItem(40, 20, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
        self.gridLayout.addItem(spacerItem, 1, 7, 1, 2)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("../../../../../_meloun/myPython/ewitis/src/ewitis/gui/img/list-add.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("../../../../../_meloun/myPython/ewitis/src/ewitis/gui/img/list-remove.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("../../../../../_meloun/myPython/ewitis/src/ewitis/gui/img/export.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("../../../../../_meloun/myPython/ewitis/src/ewitis/gui/img/emptytrash.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.gridLayout.addWidget(self.TimesIcons, 1, 10, 1, 1)
        ...
        self.RunsFilterLineEdit.setAlignment(QtCore.Qt.AlignBottom|QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft)
        ...
        self.gridLayout.addWidget(self.RunsIcons, 0, 3, 2, 1)
        self.TimesShowAll = QtGui.QCheckBox(self.tabRuns_Times)
        self.TimesShowAll.setObjectName("TimesShowAll")
        self.gridLayout.addWidget(self.TimesShowAll, 1, 9, 1, 1)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("../../../../../_meloun/myPython/ewitis/src/ewitis/gui/img/import.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.menubar.setGeometry(QtCore.QRect(0, 0, 899, 20))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.menuHelp.setTitle(QtGui.QApplication.translate("MainWindow", "Database", None, QtGui.QApplication.UnicodeUTF8))
