...
class UsersParameters(myModel.myParameters):
    ...
    def __init__(self, source):
        ...
        self.KEYS_DEF = [ \
                        ...
                        {"name":"nr",         "tabName":"nr",          "dbName":"nr"},\
                        {"name":"name",       "tabName":"name",        "dbName":"name"},\
                        {"name":"first_name", "tabName":"first_name",  "dbName":"first_name"},\
                        {"name":"category",   "tabName":"category",    "dbName":"category"},\
                        {"name":"address",    "tabName":"address",     "dbName":"user_field_1"},\
                        {"name":"club",       "tabName":"club",        "dbName":"user_field_2"}  
                    ] 
